...
function ApiKeyResultModal({ apiKey, onClose }: ApiKeyResultModalProps) {
  ...
  return (
    <Modal title="API Key 발급" onClose={onClose}>
      <p className="mt-3 text-sm leading-6 text-muted">새로운 API Key가 발급되었습니다.</p>
      <div className="mt-5 flex items-center gap-3 rounded-md border border-border bg-background p-3 max-sm:flex-col max-sm:items-stretch">
